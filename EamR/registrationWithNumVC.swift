...
class registrationWithNumVC: UIViewController {

    @IBOutlet var countrySelectionBtn: UIButton!
    @IBOutlet var dialCodeLbl: UILabel!
    @IBOutlet var userNumberTF: UITextField!
    ...
    @IBAction func countryList(_ sender: UIButton) {
        ...
        picker.didSelectCountryWithCallingCodeClosure = { name, code, dialCode in
            ...
            let bundle = "assets.bundle/"
            self.flagImageView.image = UIImage(named: bundle + code.lowercased() + ".png")
...
extension ViewController: MICountryPickerDelegate {
    func countryPicker(_ picker: MICountryPicker, didSelectCountryWithName name: String, code: String) {
        ...
        print("Country and Code \(name) \(code)")
